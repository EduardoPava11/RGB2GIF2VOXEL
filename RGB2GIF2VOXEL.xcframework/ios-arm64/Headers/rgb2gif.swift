...
public struct GifOpts {
    ...
    public init(width: UInt16, height: UInt16, frameCount: UInt16, fps: UInt16, loopCount: UInt16, optimize: Bool) {
        self.width = width
        self.height = height
...
public struct ProcessorOptions {
    public var quantize: QuantizeOpts
    public var gif: GifOpts
    public var parallel: Bool

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(quantize: QuantizeOpts, gif: GifOpts, parallel: Bool) {
...
extension ProcessorOptions: Equatable, Hashable {
    public static func ==(lhs: ProcessorOptions, rhs: ProcessorOptions) -> Bool {
        if lhs.quantize != rhs.quantize {
            return false
        }
        if lhs.gif != rhs.gif {
            return false
        }
        if lhs.parallel != rhs.parallel {
            return false
        }
        return true
    }
    ...
    public func hash(into hasher: inout Hasher) {
        hasher.combine(quantize)
        hasher.combine(gif)
        hasher.combine(parallel)
    }
}
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeProcessorOptions: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ProcessorOptions {
        return
            try ProcessorOptions(
                quantize: FfiConverterTypeQuantizeOpts.read(from: &buf), 
                gif: FfiConverterTypeGifOpts.read(from: &buf), 
                parallel: FfiConverterBool.read(from: &buf)
        )
    }

    public static func write(_ value: ProcessorOptions, into buf: inout [UInt8]) {
        FfiConverterTypeQuantizeOpts.write(value.quantize, into: &buf)
        FfiConverterTypeGifOpts.write(value.gif, into: &buf)
        FfiConverterBool.write(value.parallel, into: &buf)
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeProcessorOptions_lift(_ buf: RustBuffer) throws -> ProcessorOptions {
    return try FfiConverterTypeProcessorOptions.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeProcessorOptions_lower(_ value: ProcessorOptions) -> RustBuffer {
    return FfiConverterTypeProcessorOptions.lower(value)
}
...
extension QuantizeResult: Equatable, Hashable {
    public static func ==(lhs: QuantizeResult, rhs: QuantizeResult) -> Bool {
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeQuantizeResult: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> QuantizeResult {
        return
            try QuantizeResult(
                indices: FfiConverterSequenceUInt8.read(from: &buf), 
                palette: FfiConverterSequenceTypeRGBAColor.read(from: &buf), 
    ...
    public static func write(_ value: QuantizeResult, into buf: inout [UInt8]) {
        FfiConverterSequenceUInt8.write(value.indices, into: &buf)
        FfiConverterSequenceTypeRGBAColor.write(value.palette, into: &buf)
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeQuantizeResult_lift(_ buf: RustBuffer) throws -> QuantizeResult {
    return try FfiConverterTypeQuantizeResult.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeQuantizeResult_lower(_ value: QuantizeResult) -> RustBuffer {
    return FfiConverterTypeQuantizeResult.lower(value)
}
...
extension TensorShape: Equatable, Hashable {
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeTensorShape: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> TensorShape {
        return
            try TensorShape(
                width: FfiConverterUInt32.read(from: &buf), 
                height: FfiConverterUInt32.read(from: &buf), 
                frames: FfiConverterUInt32.read(from: &buf)
        )
    }

    public static func write(_ value: TensorShape, into buf: inout [UInt8]) {
        FfiConverterUInt32.write(value.width, into: &buf)
        FfiConverterUInt32.write(value.height, into: &buf)
        FfiConverterUInt32.write(value.frames, into: &buf)
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeTensorShape_lift(_ buf: RustBuffer) throws -> TensorShape {
    return try FfiConverterTypeTensorShape.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeTensorShape_lower(_ value: TensorShape) -> RustBuffer {
    return FfiConverterTypeTensorShape.lower(value)
}
...
public enum ProcessorError {
    ...
    case TensorError(message: String)
...
public struct FfiConverterTypeProcessorError: FfiConverterRustBuffer {
    ...
    public static func write(_ value: ProcessorError, into buf: inout [UInt8]) {
        ...
        case .TensorError(_ /* message is ignored*/):
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterSequenceTypeRGBAColor: FfiConverterRustBuffer {
    typealias SwiftType = [RgbaColor]

    public static func write(_ value: [RgbaColor], into buf: inout [UInt8]) {
        let len = Int32(value.count)
        writeInt(&buf, len)
        for item in value {
            FfiConverterTypeRGBAColor.write(item, into: &buf)
        }
    }
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [RgbaColor] {
        ...
        seq.reserveCapacity(Int(len))
        for _ in 0 ..< len {
            seq.append(try FfiConverterTypeRGBAColor.read(from: &buf))
        }
        return seq
    }
}
public func buildCubeTensor(framesRgba: [UInt8], shape: TensorShape)throws  -> [UInt8] {
    return try  FfiConverterSequenceUInt8.lift(try rustCallWithError(FfiConverterTypeProcessorError.lift) {
    uniffi_rgb2gif_processor_fn_func_build_cube_tensor(
        FfiConverterSequenceUInt8.lower(framesRgba),
        FfiConverterTypeTensorShape.lower(shape),$0
    )
})
}
public func encodeQuantizedGif(quantized: QuantizeResult, options: GifOpts)throws  -> [UInt8] {
    return try  FfiConverterSequenceUInt8.lift(try rustCallWithError(FfiConverterTypeProcessorError.lift) {
    uniffi_rgb2gif_processor_fn_func_encode_quantized_gif(
        FfiConverterTypeQuantizeResult.lower(quantized),
        FfiConverterTypeGifOpts.lower(options),$0
    )
})
}
public func processFramesToGif(framesRgba: [UInt8], width: UInt32, height: UInt32, frameCount: UInt32, options: ProcessorOptions)throws  -> [UInt8] {
    return try  FfiConverterSequenceUInt8.lift(try rustCallWithError(FfiConverterTypeProcessorError.lift) {
    uniffi_rgb2gif_processor_fn_func_process_frames_to_gif(
        FfiConverterSequenceUInt8.lower(framesRgba),
        FfiConverterUInt32.lower(width),
        FfiConverterUInt32.lower(height),
        FfiConverterUInt32.lower(frameCount),
        FfiConverterTypeProcessorOptions.lower(options),$0
    )
})
}
public func quantizeFrames(framesRgba: [UInt8], width: UInt32, height: UInt32, frameCount: UInt32, options: QuantizeOpts)throws  -> QuantizeResult {
    return try  FfiConverterTypeQuantizeResult.lift(try rustCallWithError(FfiConverterTypeProcessorError.lift) {
    uniffi_rgb2gif_processor_fn_func_quantize_frames(
        FfiConverterSequenceUInt8.lower(framesRgba),
        FfiConverterUInt32.lower(width),
        FfiConverterUInt32.lower(height),
        FfiConverterUInt32.lower(frameCount),
        FfiConverterTypeQuantizeOpts.lower(options),$0
    )
})
}
...
private var initializationResult: InitializationResult = {
    ...
    if (uniffi_rgb2gif_processor_checksum_func_build_cube_tensor() != 39539) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_rgb2gif_processor_checksum_func_encode_quantized_gif() != 35008) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_rgb2gif_processor_checksum_func_process_frames_to_gif() != 46076) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_rgb2gif_processor_checksum_func_quantize_frames() != 41259) {
        return InitializationResult.apiChecksumMismatch
    }
